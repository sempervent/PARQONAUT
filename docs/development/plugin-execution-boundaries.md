...
| Scan / finding providers | `parqonaut-core`, `parqonaut-plugin-host` | Versioned via `parqonaut-plugin-protocol` (v1) |
...
| Post-scan analyzers | `parqonaut-report` | Read-only over scan artifacts |
