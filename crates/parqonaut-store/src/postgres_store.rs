...
fn inspection_status_db(s: parqonaut_types::InspectionStatus) -> &'static str {
    match s {
        parqonaut_types::InspectionStatus::Inspected => "inspected",
        parqonaut_types::InspectionStatus::Failed => "failed",
        parqonaut_types::InspectionStatus::Skipped => "skipped",
    }
}

fn failure_kind_db(k: parqonaut_types::FailureKind) -> String {
