//! Persistence for PARQONAUT scan runs (history, projections, integrity checks): **SQLite** and **Postgres**.
//!
...
//!
//! The scan engine (`parqonaut-core`) produces [`parqonaut_types::ScanReport`] values; this crate
