...
/// Validates `Authorization: Bearer`, role policy, and attaches [`parqonaut_types::AuthPrincipal`] to request extensions.
#[allow(clippy::result_large_err)] // inherited PARQONAUT axum middleware shape
...
fn unauthorized_response(message: &str) -> Response {
    ...
    r.headers_mut()
        .insert(header::WWW_AUTHENTICATE, HeaderValue::from_static("Bearer realm=\"parqonaut\""));
    r
}
