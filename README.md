...
**Current release:** [v0.9.2](https://github.com/sempervent/PARQONAUT/releases/tag/v0.9.2) — bounded streaming Parquet publication to S3, complete local/S3 routing for transform and convert, and the 6×4 remote capability matrix. See [release notes](docs/history/v0.9.1/release-notes.md).
